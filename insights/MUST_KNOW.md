...
minyoung2(EXP01 cross-sectional 프로토콜·성숙)가 척추이며, plant(종단 확장)와 minyoung3(ROI-evidence
기반 해부학 QA/VQA 생성)가 그 프로토콜을 각각 시간축·데이터 생성 축으로 확장한다. minyoungi가
데이터·문헌·ROI QC를 공급하고, minyoung4는 휴면. (2.5D MAE SSL 라인은 2026-06-03 폐기.)
