...
> 2026-06-20. `notebook/06_cohort_bias_audit.ipynb`(라이브 측정) + 4-lens 설계 패널(평가·입력·bracket·측정게이트)
...
> 참조: `notebook/06_cohort_bias_audit.ipynb`(audit) · `docs/PRIOR_FAILURE_AND_GOFORWARD.md`(R1–R4·baseline bar) · `insight/failure_root_causes.md` · `RESEARCH_BRIEF.md`(G1/G2).
