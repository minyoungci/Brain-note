...
PENDING: no smoke summary supplied; do not execute fit commands yet.
...
CUDA_VISIBLE_DEVICES=4 \
  ...
  --amp-dtype bf16 \
  --seed 20260623 \
  --output-dir research_gsure/03_baselines/outputs/20260623_DRAFT_b1_fit_MU-Glioma-Post_192x224x160
```
...
CUDA_VISIBLE_DEVICES=4 \
  ...
  --amp-dtype bf16 \
  --seed 20260623 \
  --output-dir research_gsure/03_baselines/outputs/20260623_DRAFT_b1_fit_UCSD-PTGBM_192x224x160
```
...
CUDA_VISIBLE_DEVICES=4 \
  ...
  --amp-dtype bf16 \
  --seed 20260623 \
  --output-dir research_gsure/03_baselines/outputs/20260623_DRAFT_b1_fit_UPENN-GBM_192x224x160
```
...
CUDA_VISIBLE_DEVICES=4 \
  ...
  --amp-dtype bf16 \
  --seed 20260623 \
  --output-dir research_gsure/03_baselines/outputs/20260623_DRAFT_b1_fit_UTSW_192x224x160
```
