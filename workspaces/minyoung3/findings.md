...
> **목적:** F04 패밀리의 검증된 결과와 미검증 항목 분리 기록  ·  **출처:** `/home/vlm/minyoung3` reports·results summary.json  ·  **갱신:** 2026-06-02
...
| **F05** | ROI-informed 2.5D 확장 | 🟡 미구현 — label-join + ROI-source contract 검증 후 착수 예정(README "to be built") |
...
| ❌ 반증(헤드라인) | MAE 2.5D SSL 백본 full-train 0회. pilot/scaffold만 통과. 따라서 "SSL 표현이 임상적으로 유용하다"는 핵심 주장은 현재 무근거 |
