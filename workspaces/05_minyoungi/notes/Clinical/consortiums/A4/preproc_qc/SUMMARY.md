# A4 — preprocessed-tensor QC

Sessions QC'd: **1811**  |  PASS **1811**  WARN **0**  FAIL **0**
...
- raw brain vol (ml): min=973.600 median=1318.400 max=1821.700
- raw tensor<->mask Dice: min=1.000 median=1.000 max=1.000
- N4 tensor<->mask Dice: min=1.000 median=1.000 max=1.000
- mask Dice raw vs N4: min=0.970 median=0.982 max=1.000
