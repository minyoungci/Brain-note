# OASIS — preprocessed-tensor QC

Sessions QC'd: **1420**  |  PASS **1420**  WARN **0**  FAIL **0**
...
- raw brain vol (ml): min=1002.000 median=1306.650 max=1715.000
- raw tensor<->mask Dice: min=1.000 median=1.000 max=1.000
- N4 tensor<->mask Dice: min=1.000 median=1.000 max=1.000
- mask Dice raw vs N4: min=0.972 median=0.982 max=1.000
