# AJU — preprocessed-tensor QC

Sessions QC'd: **1287**  |  PASS **1287**  WARN **0**  FAIL **0**
...
- raw brain vol (ml): min=1002.300 median=1310.700 max=1969.000
- raw tensor<->mask Dice: min=0.999 median=1.000 max=1.000
