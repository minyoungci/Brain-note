# AIBL — preprocessed-tensor QC

Sessions QC'd: **987**  |  PASS **987**  WARN **0**  FAIL **0**
...
- raw brain vol (ml): min=953.200 median=1308.700 max=1781.000
- raw tensor<->mask Dice: min=1.000 median=1.000 max=1.000
- N4 tensor<->mask Dice: min=1.000 median=1.000 max=1.000
- mask Dice raw vs N4: min=0.970 median=0.981 max=1.000
