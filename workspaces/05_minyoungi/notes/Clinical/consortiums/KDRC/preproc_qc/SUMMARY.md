# KDRC — preprocessed-tensor QC

Sessions QC'd: **909**  |  PASS **909**  WARN **0**  FAIL **0**
...
- raw brain vol (ml): min=966.500 median=1289.600 max=1754.900
- raw tensor<->mask Dice: min=1.000 median=1.000 max=1.000
- N4 tensor<->mask Dice: min=1.000 median=1.000 max=1.000
- mask Dice raw vs N4: min=0.971 median=0.985 max=1.000
