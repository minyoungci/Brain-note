...
- 🚀 **full run(anat + curated-b1000-dwi) 진행 중**: `preprocess_fomo300k.py --modalities --num-workers 32`(dwi-bval 기본 800~1200). out=`/home/vlm/data/FOMO300K_preprocessed`. 중단시 동일명령 resume. 예상 ~210K(anat 182K + b1000-dwi ~28K).
