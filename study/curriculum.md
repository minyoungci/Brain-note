...
_무엇을, 어떤 순서로 학습할지. 이 연구 프로그램을 처음부터 이해하는 경로._
_갱신: 2026-06-02._

## 학습 순서 (의존성대로)

### STEP 0 — 전체 지도 (30분)
1. `../DASHBOARD.md` — 5개 워크스페이스가 뭘 하는지 한 장으로.
2. `../insights/MUST_KNOW.md` — 핵심 교훈 먼저 머리에 박기.
...
### STEP 4 — 비판적 종합
- `../insights/MUST_KNOW.md`의 [VERIFY] 목록을 하나씩 추적: 어느 게 아직 안 풀렸나?
- 각 워크스페이스 `risks.md`를 읽고 "내가 reviewer 2라면 어디를 때릴까" 연습.
